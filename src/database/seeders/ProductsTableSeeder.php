...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param=[
            'name'=>'キウイ',
            'price'=>'800',
            'image'=>'wkgaVLN2fq6jyvdoRQk2kYsa2oF25jp1RjKKRD6b.png',
        ...
        $param=[
            'name'=>'ストロベリー',
            'price'=>'1200',
            'image'=>'d8z9DAdL0hhpsLbTqFs3WqH7qO0cuur65lj1oYIy.png',
        ...
        $param=[
            'name'=>'オレンジ',
            'price'=>'850',
            'image'=>'G3zb1k1ATurWSObbFcI0t4sRGweiqhsowKjaDTB6.png',
        ...
        $param=[
            'name'=>'スイカ',
            'price'=>'700',
            'image'=>'sZArHsWjldIbji7wBm4RY29jfPzliN8UXO8HuvoU.png',
        ...
        $param=[
            'name'=>'ピーチ',
            'price'=>'1000',
            'image'=>'6GStUNMI1htddU5HYnj6vxjMurQTeERU4InQ3qe1.png',
        ...
        $param=[
            'name'=>'パイナップル',
            'price'=>'800',
            'image'=>'GLuUDJMxLoumvHDcgLPt5uvz09Noxd6v7lIiYtm2.png',
        ...
        $param=[
            'name'=>'ブドウ',
            'price'=>'1100',
            'image'=>'Pes26qJef9qWQKJ4qg5SE2gcWQD431cEsDPXnDWK.png',
        ...
        $param=[
            'name'=>'バナナ',
            'price'=>'600',
            'image'=>'1Px8lyTzicSKNESZcW67d6qXCBzFE7Mi0SU0uxEK.jpg',
        ...
        $param=[
            'name'=>'メロン',
            'price'=>'900',
            'image'=>'b7ZBcPNJURc26AW4YP9iilWYzwNl90xSwgcJeLpF.jpg',
